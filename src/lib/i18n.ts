...
const ko = {
  ...
  "damage.gutsInfo": "근성: 상태이상 공격 ×1.5",
  "damage.burnInfo": "화상: 물리 공격 ×0.5",
  ...
  "dex.bstN": "종족값 {n}",
  "dex.bstTitle": "종족값 총합",
  "dex.selectedStatTitle": "선택한 능력치 종족값",
  "dex.type": "타입",
  "dex.typeHint": "(최대 2개, 둘 다 가진 포켓몬)",
  "dex.formsMoves": "폼 · 기술",
  "dex.megaOnly": "메가만",
  "dex.priorityOnly": "선공기 보유",
  "dex.wideGuard": "와이드가드",
  "dex.sort": "정렬",
  "dex.byStat": "(능력치순)",
  "dex.default": "기본",
...
const en: Record<Key, string> = {
  ...
  "damage.gutsInfo": "Guts: status Attack ×1.5",
  "damage.burnInfo": "Burn: physical Attack ×0.5",
  ...
  "dex.viewN": "View {n}",
  "dex.bstN": "BST {n}",
  "dex.bstTitle": "Base stat total",
  "dex.selectedStatTitle": "Selected stat",
  "dex.type": "Type",
  "dex.typeHint": "(up to 2, Pokémon with both)",
  "dex.formsMoves": "Forms · Moves",
  "dex.megaOnly": "Mega only",
  "dex.priorityOnly": "Has priority move",
  "dex.wideGuard": "Wide Guard",
  "dex.sort": "Sort",
  "dex.byStat": "(by stat)",
  "dex.default": "Default",
  "dex.sortDesc": "High → Low ↓",
...
const ja: Record<Key, string> = {
  ...
  "damage.gutsInfo": "こんじょう: 状態異常時こうげき ×1.5",
  "damage.burnInfo": "やけど: 物理こうげき ×0.5",
  ...
  "dex.bstN": "種族値 {n}",
  "dex.bstTitle": "種族値合計",
  "dex.selectedStatTitle": "選択した能力の種族値",
  "dex.type": "タイプ",
  "dex.typeHint": "(最大2つ、両方を持つポケモン)",
  "dex.formsMoves": "フォルム · 技",
  "dex.megaOnly": "メガのみ",
  "dex.priorityOnly": "先制技持ち",
  "dex.wideGuard": "ワイドガード",
  "dex.sort": "並び替え",
  "dex.byStat": "(能力値順)",
  "dex.default": "デフォルト",
  "dex.sortDesc": "高い順 ↓",
