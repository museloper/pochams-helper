...
const ko = {
  ...
  "common.all": "전체",
  "common.ability": "특성",
  "common.abilityHidden": "*",
  "common.abilityHiddenNote": "* 드림특성",
  "common.item": "도구",
  "common.physical": "물리",
  "common.special": "특수",
  ...
  "damage.powerMod": "위력 {from}→{to}",
  "damage.weatherBallInfo": "웨더볼 위력 {power}",
  "damage.megaSolInfo": "메가솔라: 항상 쾌청 적용",
  ...
  "speed.scarfOff": "미착용",
  "speed.abilityOn": "발동 (×{mult})",
  "speed.abilityOff": "미발동",
  "speed.mySpeed": "내 스피드",
  ...
  "dex.moveFilter": "기술 필터",
  "dex.moveFilterPlaceholder": "기술 이름 입력",
  "dex.abilityFilter": "특성 필터",
  "dex.abilityFilterPlaceholder": "특성 이름 입력",
  "dex.sort": "정렬",
  "dex.byStat": "(능력치순)",
  "dex.default": "기본",
  "dex.sortDesc": "높은 순 ↓",
...
const en: Record<Key, string> = {
  ...
  "common.abilityHidden": "*",
  "common.abilityHiddenNote": "* Hidden ability",
  "common.item": "Item",
  ...
  "damage.powerMod": "power {from}→{to}",
  "damage.weatherBallInfo": "Weather Ball power {power}",
  "damage.megaSolInfo": "Mega Sol: always harsh sunlight",
  ...
  "speed.scarfOff": "None",
  "speed.abilityOn": "Active (×{mult})",
  "speed.abilityOff": "Off",
  ...
  "dex.moveFilter": "Move filter",
  "dex.moveFilterPlaceholder": "Type a move name",
  "dex.abilityFilter": "Ability filter",
  "dex.abilityFilterPlaceholder": "Type an ability name",
  "dex.sort": "Sort",
  "dex.byStat": "(by stat)",
  "dex.default": "Default",
...
const ja: Record<Key, string> = {
  ...
  "damage.powerMod": "威力 {from}→{to}",
  "damage.weatherBallInfo": "ウェザーボール 威力 {power}",
  "damage.megaSolInfo": "メガソル: 常にはれ状態",
  ...
  "speed.scarfOff": "未装備",
  "speed.abilityOn": "発動 (×{mult})",
  "speed.abilityOff": "未発動",
  ...
  "dex.moveFilter": "技フィルター",
  "dex.moveFilterPlaceholder": "技名を入力",
  "dex.abilityFilter": "とくせいフィルター",
  "dex.abilityFilterPlaceholder": "とくせい名を入力",
  "dex.sort": "並び替え",
  "dex.byStat": "(能力値順)",
  "dex.default": "デフォルト",
  "dex.sortDesc": "高い順 ↓",
